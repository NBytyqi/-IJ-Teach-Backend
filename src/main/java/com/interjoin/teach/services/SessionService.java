...
public class SessionService {
    ...
    public String bookSession(BookSessionRequest request) throws InterjoinException {
       ...
       String urlParams = String.format("/booking-status?subject=%s&curriculum=%s&time=%s&date=%s&status=IN_REVIEW", request.getSubject(), request.getCurriculum(), request.getDate().getHourMinuteString(), request.getDate().getDateOfSession().toString());
